...
export default class UserDao {
  ...
  updateUser (_id, user) {
    ...
    return UserSchema.findByIdAndUpdate({ _id }, { $set: user }, { new: true })
  }

  getUserById (_id) {
    this.logger.info('mongoose getUserById');
    return UserSchema.findById(_id, '-password -countLoginFailed -timeToUnlock')
  }
  ...
  getUserListByCriteria (criteria) {
    this.logger.info('mongoose getUserByCriteria');
    return UserSchema.find(criteria, '-password -countLoginFailed -timeToUnlock')
  }
